...
},{"base64-js":"node_modules/base64-js/index.js","ieee754":"node_modules/ieee754/index.js","isarray":"node_modules/isarray/index.js","buffer":"node_modules/buffer/index.js"}],"face-api.min.js":[function(require,module,exports) {
var define;
...
!function (t, e) {
  ...
  function Gt() {
    ...
    var t,
        a,
        n = (t = window.location.search, a = {}, t.replace(/[?&]([^=?&]+)(?:=([^&]*))?/g, function (t) {
      ...
      h && (s = this.startTimer()), function (a, s, t, e, n) {
        ...
        e.texData.isPacked ? a.setOutputPackedMatrixTexture(r, o[0], o[1]) : a.setOutputMatrixTexture(r, o[0], o[1]), a.setProgram(s.webGLProgram), 1 === Zt.get("WEBGL_VERSION") && (null !== s.infLoc && a.gl.uniform1f(s.infLoc, 1 / 0), null !== s.nanLoc && a.gl.uniform1f(s.nanLoc, NaN)), t.forEach(function (t, e) {
          ...
          if (null != r) if (t.isUniform) {
            if (B(t.shape) < 2) a.gl.uniform1f(r, t.uniformValues[0]);else {
...
},{"crypto":"node_modules/parcel-bundler/src/builtins/_empty.js","fs":"node_modules/parcel-bundler/src/builtins/_empty.js","process":"node_modules/process/browser.js","buffer":"node_modules/buffer/index.js"}]},{},["face-api.min.js"], null)
//# sourceMappingURL=/face-api.min.9a45e2f4.js.map